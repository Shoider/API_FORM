...
\textbf{La configuración de navegación del perfil básico contempla las siguientes categorías, necesarias para el desempeño sustantivo y la adecuada gestión de los recursos informáticos.} &  &     \\
{•	Negocios y economía.\\
•	Información sobre computadoras e internet .\\
...
•	Compras.\\
•	Viajar.\\
•	Correo eletctrónico basado en la web.} \\

{\textbf {Perfil comunicación social:}} Incorpora el perfil básico y contempla opciones adicionales que deberá seleecionar, las cuales serán  justificadas plenamente  y autorizadas por el Director o Gerente del área de adscripción.
\end{longtblr}
