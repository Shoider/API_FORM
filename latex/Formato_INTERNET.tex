...
\begin{longtblr}[
	...
	entry = none,
		...
		%Fecha: \today                      &                                                                                                       \\
		{Usuario que acepta\\~\\[0.7cm] \rule{5cm}{0.5mm}\\PUESTO Y NOMBRE} & {~\\~\\[0.7cm] \rule{5cm}{0.5mm}\\Lic. Alfonso Isaac Frías Castillo\\ ~\\Subgerente de Soporte Técnico,\\Telecomunicaciones y Seguridad} &
                     {Gerente o Director Local que Autoriza\\[0.7cm] \rule{5cm}{0.5mm}\\PUESTO Y NOMBREI}
	\end{longtblr}
{\textbf{Nota:}}
