...
\end{itemize}
	...
	entry = none,
		...
		%Fecha: \today                      &                                                                                                       \\
		{Usuario que acepta\\[0.7cm] \rule{6cm}{0.5mm}\\\NOMS\\\PUESTOS} & {Gerente o director local que autoriza.\\[0.7cm] \rule{6cm}{0.5mm}\\\NOMBREJEFE\\\PUESTOJEFE} \\
                     {Enlace Informático\\[0.7cm] \rule{6cm}{0.5mm}\\\NOMEI\\\PUESTOEI}
	\end{longtblr}
