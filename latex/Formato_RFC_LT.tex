...
\lhead{
	...
	\includegraphics[width=0.2\textwidth]{imagenes/Logo_de_la_Conagua} & {\textbf {COMISIÓN NACIONAL DEL AGUA}\\Gerencia de Tecnología de Información y Comunicaciones. \\ Subgerencia de Soporte Técnico, Telecomunicaciones y Seguridad.} & \footnotesize HOJA    & {\footnotesize \thepage\ de \pageref{LastPage}} \\
