...
\newboolean{haytemporalinter}
\setboolean{haytemporalinter}{\HAYTEMPORALINTER} 
%\ifthenelse{\boolean{haytemporalinter}}
%{
\vspace{-20pt}
\begin{longtblr}[
	label = none,
...
\newboolean{haytemporaladmin}
\setboolean{haytemporaladmin}{\HAYTEMPORALADMIN} 
%\ifthenelse{\boolean{haytemporaladmin}}
%{
\vspace{-20pt}
\begin{longtblr}[
	label = none,
...
\newboolean{haytemporaldes}
\setboolean{haytemporaldes}{\HAYTEMPORALDES} 
%\ifthenelse{\boolean{haytemporaldes}}
%{
\vspace{-20pt}
\begin{longtblr}[
	label = none,
...
\newboolean{haytemporalusua}
\setboolean{haytemporalusua}{\HAYTEMPORALUSUA} 
%\ifthenelse{\boolean{haytemporalusua}}
%{
\vspace{-20pt}
\begin{longtblr}[
	label = none,
