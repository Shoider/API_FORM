...
\clearpage
\newboolean{altas}
\setboolean{altas}{\ALTAS} 

%%PARA BAJAS
\newboolean{bajas}
\setboolean{bajas}{\BAJAS} 
...
\DTLforeach*{ALTAS}{\No=N, \NombreAdmin=SO, \IPOri=IPO, \SistemaDes=SD, \FuncionDes=FRD, \IPDes=IPD, \Protocolo=PRO, \Puertos=PUER}
{
\vspace{-37pt}
 \begin{longtblr}[
 label = none,
...
\DTLforeach*{BAJAS}{\No=N, \NombreAdmin=SO, \IPOri=IPO, \SistemaDes=SD, \FuncionDes=FRD, \IPDes=IPD, \Protocolo=PRO, \Puertos=PUER}
{
\vspace{-37pt}
 \begin{longtblr}[
 label = none,
...
\DTLforeach*{ALTAS}{\No=N, \NombreDes=SO, \IPOri=IPO, \SistemaDes=SD, \FuncionDes=FRD, \IPDes=IPD, \Protocolo=PRO, \Puertos=PUER}
{
\vspace{-37pt}
 \begin{longtblr}[
 label = none,
...
\DTLforeach*{BAJAS}{\No=N, \NombreDes=SO, \IPOri=IPO, \SistemaDes=SD, \FuncionDes=FRD, \IPDes=IPD, \Protocolo=PRO, \Puertos=PUER}
{
\vspace{-37pt}
 \begin{longtblr}[
 label = none,
...
\DTLforeach*{ALTAS}{\No=N, \NombreUsua=SO, \IPOri=IPO, \SistemaDes=SD, \FuncionDes=FRD, \IPDes=IPD, \Protocolo=PRO, \Puertos=PUER}
{
\vspace{-37pt}
 \begin{longtblr}[
 label = none,
...
\DTLforeach*{BAJAS}{\No=N, \NombreUsua=SO, \IPOri=IPO, \SistemaDes=SD, \FuncionDes=FRD, \IPDes=IPD, \Protocolo=PRO, \Puertos=PUER}
{
\vspace{-37pt}
 \begin{longtblr}[
 label = none,
