...
\lhead{
	...
	& { Solicitud del Servicio de VPN}                                       &  \includegraphics[width=0.05\textwidth]{imagenes/Logo_Octubre_2024}       &           
\end{tblr}
}
\chead{
...
\begin{longtblr}[
	...
	Numero de formato:  &\NOFORMATO       & Fecha:   &\DTMsetdatestyle{ddmmyyyy}  \today       \\
