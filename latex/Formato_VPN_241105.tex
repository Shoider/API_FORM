...
\lhead{
	...
	\includegraphics[width=0.2\textwidth]{imagenes/Logo_de_la_Conagua} & {Comisión Nacional del Agua\\Gerencia de Tecnologías de Información \\y Comunicaciones} & \tiny Hoja    & {\tiny \thepage\ de \pageref{LastPage}} \\
...
\begin{longtblr}[
	...
	entry = none,
		...
		cell{4}{2} = {c=3}{0.649\linewidth},
                      %cell{5}{2} = {c=3}{0.249\linewidth},
		cell{6}{2} = {c=3}{0.249\linewidth},
		hlines,
		vlines,
	}
\textbf{Datos de Usuario (a)} &  &      &  \\
%SetCell{c=2}{puesto o cargo} & \NOMBRE\\
Nombre:                     &  \NOMBRE \\
...
\begin{longtblr}[
	...
	entry = none,
		...
		%column{4} = {r},
                     	cell{1}{1} = {c=4}{0.874\linewidth},
		%cell{2}{2} = {c=3}{0.249\linewidth},
		%cell{3}{2} = {c=3}{0.249\linewidth},
		%cell{4}{2} = {c=3}{0.249\linewidth},
		%cell{5}{2} = {c=3}{0.249\linewidth},
		%cell{6}{2} = {c=3}{0.249\linewidth},
		hlines,
		vlines,
